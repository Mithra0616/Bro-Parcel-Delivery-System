Public Class SplashScreem3
    ' Declare an instance of User_Login at the class level
    Private rider_login As New Rider_Login()
    ...
    Private Sub ShowRiderLogin()
        Timer1.Stop() ' Stop the timer
        rider_login.Show() ' Show the User_Login form
        Me.Close() ' Close the splash screen
    End Sub

    Private Sub SplashScreem3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
